                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
                            <ul>
                                ...
                                <li><strong>{{ __('Unit') }} :</strong> {{ $incidentInformation->unit }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="row ">
        <div class="col-12 mt-4">
            <div class="arrow-steps clearfix">
                <div class="step {{ $incidentInformation->statu == 1 ? 'current' : '' }} {{ $incidentInformation->statu <= 1 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(1)">{{ __('Open') }}</a></span> </div>
                <div class="step {{ $incidentInformation->statu == 2 ? 'current' : '' }} {{ $incidentInformation->statu <= 2 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(2)">{{ __('In process') }}</a></span> </div>
                <div class="step {{ $incidentInformation->statu == 3 ? 'current' : '' }} {{ $incidentInformation->statu <= 3 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(3)">{{ __('Corrective Actions') }}</a></span> </div>
                <div class="step {{ $incidentInformation->statu == 4 ? 'current' : '' }} {{ $incidentInformation->statu <= 4 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(4)">{{ __('Resolved') }}</a><span> </div>
                <div class="step {{ $incidentInformation->statu == 5 ? 'current' : '' }} {{ $incidentInformation->statu <= 5 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(5)">{{ __('Pending') }}</a><span> </div>
                <div class="step {{ $incidentInformation->statu == 6 ? 'current' : '' }} {{ $incidentInformation->statu <= 6 ? ' ' : 'done' }}"> <span><a href="#" wire:click="changeStatu(6)">{{ __('Closed') }}</a><span> </div>
            </div>
        </div>
    </div>
    <div class="row">
